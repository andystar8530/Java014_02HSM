...
<!-- 					</div> -->
<%-- 					<a href="<c:url value='/newlywed_h/newlywed' />" --%>
<!-- 						class="list-group-item"><img -->
<%-- 						src="<c:url value='/data/icon/3253474-wedding/png/007-house.png' /> ">基本資料 --%>
<!-- 					</a> <a class="list-group-item" -->
<%-- 						href="<c:url value='/nrm/${LoginOK.m_No}'/>"><img --%>
<%-- 						src="${pageContext.request.contextPath}/data/icon/3253474-wedding/png/007-house.png">帳號資料</a> --%>

<%-- 					<a href="<c:url value='/newlywed_h/wedding'/>" --%>
<!-- 						class="list-group-item"><img -->
...
<%-- 						src="<c:url value='/data/icon/3253474-wedding/png/001-clipboard.png' />">我的討論區 --%>
<!-- 					</a> <a class="list-group-item list-group-2"><img -->
...
<!-- 			到這裡 -->
			...
			<div class="col-lg-9 mb-4">
				<h2>基本資料&nbsp;</h2>
				<a href="<c:url value='/newlywed_h/newlywedInfo'/>"><img
					src="<c:url value='/data/icon/document.png' />" width="30"
					class="editInfo"></a>
				<div class="newlyWed">
				...
				<c:if test="${NewlywedBean.n_budget ==1 }">
				<div class="newlyWed">
					婚禮預算:<span>20萬~~50萬</span>
				</div>
				</c:if>
				<c:if test="${NewlywedBean.n_budget == 2 }">
				<div class="newlyWed">
					婚禮預算:<span>50萬~~100萬</span>
				</div>
				</c:if>
				<c:if test="${NewlywedBean.n_budget == 3 }">
				<div class="newlyWed">
					婚禮預算:<span>100萬~~150萬</span>
				</div>
				</c:if>
				
				
				<c:if test="${NewlywedBean.n_area==0}">
					<div class="newlyWed">
						婚禮地區:<span>北部</span>
					</div>
				</c:if>
				<c:if test="${NewlywedBean.n_area==1}">
					<div class="newlyWed">
						婚禮地區:<span>中部</span>
					</div>
				</c:if>
				<c:if test="${NewlywedBean.n_area==2}">
					<div class="newlyWed">
						婚禮地區:<span>南部</span>
					</div>
				</c:if>
				<c:if test="${NewlywedBean.n_area==3}">
					<div class="newlyWed">
						婚禮地區:<span>東部</span>
					</div>
				</c:if>
					<c:if test="${NewlywedBean.n_area==4}">
					<div class="newlyWed">
						婚禮地區:<span>離島</span>
					</div>
				</c:if>
