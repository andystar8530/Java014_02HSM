...
<!--      			 			</div> -->
			...
			<div class='text-center'>
				<p>
<%-- 					<a href="<c:url value='/showPartnerDetail/${portfolio.partnerBean.p_id}'/>" class="btn btn-default"> --%>
<!-- 						<span class="glyphicon-hand-left glyphicon"></span>返回上頁 -->
<!-- 					</a>  -->
				<a href="<c:url value='/quote/askingQuote?p_id=${portfolio.partnerBean.p_id}'/>"
